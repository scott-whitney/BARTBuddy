...
function renderButtons(){
    for(i=0; i<bartStationArray.length; i++){
       $('.destiny').append($('<option>').text(bartStationArray[i].stationName).attr('value', bartStationArray[i].Abbr))
       $('.origin').append($('<option>').text(bartStationArray[i].stationName).attr('value', bartStationArray[i].Abbr))
    }
